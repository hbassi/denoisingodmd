...
def main(molecule, noise, Tmax, overlap, dt, numpad, option='', denoised=False):
    ...
    if not denoised:
        ...
        clipped[0] = 1.0
        savename = f'{molecule}_FFT_zero_padding_noise={noise}_Tmax={Tmax}_overlap={overlap}_dt={dt}'
        ...
        savename = f'{molecule}_fourier_denoised_zero_padding_noise={noise}_Tmax={Tmax}_overlap={overlap}_dt={dt}_'
